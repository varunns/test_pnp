...
CameraModel::CameraModel()
{
 /* intrinsic_matrix.at<double>(0, 0) = 235.483; //319.59208146;
  ...
  intrinsic_matrix.at<double>(0, 0) = 235.523; //319.59208146;
  intrinsic_matrix.at<double>(1, 1) = 235.523; //237.53868415;
  intrinsic_matrix.at<double>(0, 2) = 319.093; //235.48376383;
  intrinsic_matrix.at<double>(1, 2) = 237.495; //235.36168732;
  intrinsic_matrix.at<double>(2, 2) = 1.0;
								...
								std::vector<cv::Point2d>& points2)
{
	...
	{
		cv::Point2d pt = getImagePoint(points3[i], R, T);
